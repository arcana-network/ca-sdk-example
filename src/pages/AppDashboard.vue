  ...
  <div class="flex gap-12 w-full">
    ...
    >
      ...
      <div class="flex-1 flex flex-col gap-8 mt-6">
        ...
        >
          ...
          >
            ...
            <div class="flex flex-col items-end text-blueGray-800 max-xl:w-40">
              <AppTooltip
      ...
      <div class="mt-auto pt-4">
        <div class="flex gap-4">
          <button class="button-primary w-full h-11">Bridge</button>
          <button class="button-primary w-full h-11">Send</button>
        </div>
      </div>
    </div>
    ...
    >
      ...
      <div class="flex-1 flex flex-col gap-8 mt-6">
        ...
        >
          <div class="flex flex-col" v-for="(asset, i) in balances" :key="i">
            <Accordion.Root
      ...
      <div class="mt-auto pt-4">
        <div class="flex gap-4">
          <button class="button-primary w-full h-11">
            Bridge Unified Balance
          </button>
          <button class="button-primary w-full h-11" @click.stop="startSteps">
